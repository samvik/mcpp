...
public:
     ...
     * @param timeout Number of micro seconds to wait. A value of -1 will wait
     * indefinitely.
...
protected:
     ...
     * @return True if the data was successfully sent to mongrel, false
     * otherwise.
     */
...
public:
     ...
     * @return True if the data was successfully delivered to mongrel, false
     * otherwise.
     */
     ...
     * @param content Data to reply with.
     * @return True if successful, false otherwise.
     */
    bool reply(const Request &request, const std::string &content);
     ...
     * @return True if successful, false otherwise.
     */
    bool replyHttpJson(const Request &request, const std::string &content,
                       http::StatusCode code = http::StatusCode::OK,
                       const json &headers = {});
     ...
     * @return True if successful, false otherwise.
     */
    bool replyHttpJson(const Request &request, const json &content,
                       http::StatusCode code = http::StatusCode::OK,
                       const json &headers = {});
     ...
     * @return True if successful, false otherwise.
     */
    bool acceptWebsocket(const Request &request, json headers = {});
     ...
     * @return True if successful, false otherwise.
     */
    bool rejectWebsocket(const Request &request, json headers = {});
    ...
    bool deliverWebsocket(const std::string &uuid,
                          ...
                          const std::string &data, websocket::OpCode opcode,
                          char rsvd = 0x00);
    ...
    bool deliverWebsocketJson(const std::string &uuid,
                              const std::vector<unsigned> ids,
                              const json &content, websocket::OpCode opcode,
                              char rsvd = 0x00);
